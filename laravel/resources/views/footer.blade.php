        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-2 col-lg-3">
                    ...
                    <ul class="mf">
                        <li>
                            <a href="<?php  ?>pages/about.php">ارتباط با ما</a>
                        </li>
                        <li>
                            <a href="<?php  ?>pages/about.php">درباره باراد</a>
                        </li>
                        <li>
                ...
                <div class="col-xs-12 col-sm-3 col-md-2 col-lg-3">
                    ...
                    <ul class="mf">
                        <li>
                            <a href="<?php  ?>pages/register.php">ایجاد حساب کاربری جدید</a>
                        </li>

                        <li>
                            <a href="<?php  ?>index.php">ورود به سایت</a>
                        </li>

                        <li>
                            <a href="<?php  ?>pages/factor.php">سبد خرید</a>
                        </li>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                ...
                <div class="pull-left">
                    <strong>Shayan Yousefian And Negar Bayati</strong> - Copyright 2015 - All rights reserved
                </div>
            </div>
        </div>
    </div>
