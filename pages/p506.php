	...
	<div class="container" id="menu-fixed">
		<div class="box">
			<ul class="detail-menu">
				...
				<li><a href="#sc-two" title="">محصولات مشابه</a></li>
				<li><a href="#sc-three" title="">نقد و بررسی</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="pd">
                        <h3>
                             Lenovo Z5170  i7 RAM 16GB  1T
                            <small>لنوو زد 5170 گرافیک 4 گیگابایت</small>
                        </h3>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="info">
                                ...
                                <div class="choice-color">
                                    <div class="color-type">انتخاب رنگ  : <span> (   سفید     )</span></div>
                                    <ul class="color_check">
                                        ...
                                        <li class="dropup">
                                            <label>
                                                <input class="color_9" onchange="getOptionValue(9, 'color', 506);left_gallery('tab21');"  name="color"  type="radio" value="9"  />
                            ...
                            <div class="ttd">
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>توضیحات درایو نوری</td>
                                            <td>

                                                DVD-RW-Super-Multi DVD
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                لیتیوم-یون با ظرفیت 41 واتساعت
